...
![](img_descriptive_analysis/dispersion_01_people.png)
...
![](img_descriptive_analysis/dispersion_02_people.png)
...
![](img_descriptive_analysis/dispersion_03_overview.png)
...
![](img_descriptive_analysis/dispersion_04_edges.png)

Or are people “evenly distributed” across the range of heights for the class? 

![](img_descriptive_analysis/dispersion_05_even.png)
...
![](img_descriptive_analysis/dispersion_06_variance.png)

Then, let’s measure the difference, or distance, between each person’s height and the mean height.

![](img_descriptive_analysis/dispersion_07_variance.png)

Then we square the differences. 

![](img_descriptive_analysis/dispersion_08_variance.png)

Then we add up all the squared differences.

![](img_descriptive_analysis/dispersion_09_variance.png)
...
![](img_descriptive_analysis/dispersion_10_variance.png)
...
![](img_descriptive_analysis/dispersion_11_sd.png)
...
![](img_descriptive_analysis/dispersion_12_sd.png)
...
* We used `map_dbl()` to iterate over each column in the data. Check out [R4DS, Chapter 21](https://r4ds.had.co.nz/iteration.html#for-loops-vs.functionals) if you need a refresher on iteration.
